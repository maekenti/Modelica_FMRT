...
// Annotation --------------------
  ...
  model Simulation_Flaschenzug_oben
      Flaschenzug_Bibliothek.Antriebsstrang.Spannungsquelle Spannungsquelle1(T1 = 20, T2 = 30, U1 = 48, U2 = 0, U3 = 0)  annotation(
      ...
      Flaschenzug_Bibliothek.Mechanik.Flaschenzug_Zugrichtung_oben flaschenzug_Zugrichtung_oben1 annotation(
    ...
    equation
      ...
      connect(flaschenzug_Zugrichtung_oben1.F_s_Antrieb, seilwinde1.s_F_Connector) annotation(
      ...
      connect(flaschenzug_Zugrichtung_oben1.F_s_Last, masse1.s_F_Connector) annotation(
  ...
  Flaschenzug_Bibliothek.Mechanik.Flaschenzug_Zugrichtung_unten flaschenzug_Zugrichtung_unten1 annotation(
  ...
  Flaschenzug_Bibliothek.Mechanik.Masse masse1 annotation(
    ...
    connect(flaschenzug_Zugrichtung_unten1.F_s_Antrieb, seilwinde1.s_F_Connector) annotation(
        Line(points = {{46, -3}, {46, -10}, {32, -10}}));
      connect(einphasen_Gleichstrommotor1.phi_M_Connector, bremse1.phi_M_Antrieb) annotation(
        Line(points = {{-20, -80}, {-14, -80}, {-14, -54}, {-44, -54}, {-44, -28}}));
      connect(bremse1.U_I_Connector, einphasen_Gleichstrommotor1.U_I_Connector) annotation(
        Line(points = {{-40, -17}, {-56, -17}, {-56, -87.2}}));
    connect(flaschenzug_Zugrichtung_unten1.F_s_Last, masse1.s_F_Connector) annotation(
